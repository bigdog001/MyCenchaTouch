...
$genreid = formatStr($params->genreid);
...
{
    $type = ($_REQUEST['type'] !=null) ? $_REQUEST['type'] :1;
	...
	die('{"success":true,"books":""}');
    }
}
else if($_SERVER["REQUEST_METHOD"]=="POST")
{
    $sql="insert into books(genreid,image_url,book_name,author,description)";
    $sql=$sql."values(";
    $sql=$sql."'".$genreid."',"; 
    $sql=$sql."'".$image_url."',";  
    $sql=$sql."'".$book_name."',";
